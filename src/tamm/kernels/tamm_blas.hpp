...
template<typename T>
void transpose_reorder(T*& out, const T* in, const int* outDims, const int* rdims);
} // namespace cpu
...
template<typename T>
void transpose_reorder(T*& out, const T* in, const int* outDims, const int* rdims, gpuStream_t& thandle);
} // namespace gpu
#endif
